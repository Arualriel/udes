...
#dudt = FastChain(FastDense(2,32,tanh), #teste 1
#                 FastDense(32,2))

#dudt = FastChain(FastDense(2,32,tanh), #teste 2
#                 FastDense(32,32,tanh),FastDense(32,2))

#dudt = FastChain(FastDense(2,16,tanh), #teste 3
#                 FastDense(16,16,tanh),FastDense(16,2))

#dudt = FastChain(FastDense(2,16,tanh), #teste 4
#                 FastDense(16,16,tanh),FastDense(16,16,tanh),FastDense(16,2))

#dudt = FastChain(FastDense(2,8,tanh), #teste 5
#                 FastDense(8,8,tanh),FastDense(8,8,tanh),FastDense(8,2))

#dudt = FastChain(FastDense(2,8,tanh), #teste 6
#                 FastDense(8,8,tanh),FastDense(8,8,tanh),FastDense(8,8,tanh),FastDense(8,2))

dudt = FastChain(FastDense(2,64,tanh), #teste 7
                 FastDense(64,2))
